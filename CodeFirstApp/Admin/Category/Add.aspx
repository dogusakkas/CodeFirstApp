...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContentPlaceHolder" runat="server">
    ...
    <div class="form-group">
        ...
        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="TxtCategoryName" Display="Dynamic" ForeColor="Red" ></asp:RequiredFieldValidator>
    </div>
    ...
    <br />
    <asp:Button ID="List" runat="server" href="/ListCategory" Text="List" CssClass="btn btn-success"   />
